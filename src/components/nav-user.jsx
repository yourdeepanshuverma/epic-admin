        ...
        <DropdownMenu>
          ...
          >
            ...
            {otherAccounts.length > 0 && (
              <>
                <DropdownMenuSeparator />
                <DropdownMenuLabel className="text-muted-foreground px-2 py-1 text-xs font-bold tracking-wider uppercase">
                  Switch Account
                </DropdownMenuLabel>
                <DropdownMenuGroup>
                    ...
                    >
                      <Avatar className="mr-2 h-6 w-6 rounded-md">
                        ...
                        <AvatarFallback className="text-[10px]">
                          {account.user.vendorName?.[0] || "U"}
                        </AvatarFallback>
                      </Avatar>
                      <span className="flex-1 truncate">
                        {account.user.vendorName || account.user.name}
                      </span>
                      <IconSwitchHorizontal className="text-muted-foreground size-4" />
                    </DropdownMenuItem>
                  ))}
                </DropdownMenuGroup>
              </>
