...
import { useAddVenueVideoMutation, useDeleteVenueVideoMutation } from "../../../../store/api/vendorApi";
...
const VenueVideosTab = ({ pkg }) => {
  const [addVideo, { isLoading: isAdding }] = useAddVenueVideoMutation();
  const [deleteVideo, { isLoading: isDeleting }] = useDeleteVenueVideoMutation();
