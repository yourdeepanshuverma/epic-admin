...
import { useAddVenueFaqMutation, useDeleteVenueFaqMutation } from "../../../../store/api/vendorApi";
...
const VenueFaqsTab = ({ pkg }) => {
  const [addFaq, { isLoading: isAdding }] = useAddVenueFaqMutation();
  const [deleteFaq, { isLoading: isDeleting }] = useDeleteVenueFaqMutation();
          ...
          <DialogContent>
            ...
            <form onSubmit={handleAddFaq} className="space-y-4 mt-4">
              ...
              <div className="space-y-2">
                <Label>Answer</Label>
                <Textarea 
                  placeholder="e.g. Yes, we have valet parking..." 
                  value={answer}
